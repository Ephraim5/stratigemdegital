  ...
  const textSections = useMemo(() => {
    return [
      ...
      },
      {
        ...
        subtitle: `Your Website is your digital storefront. We create visually stunning, user-friendly websites designed to turn visitors into loyal customers. Whether it's an E-commerce store or a corporate site, we've got you covered.`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
        ...
        subtitle: `Harness the power of the paid advertising. Our team optimizes ad campaigns on Google, Meta and other platforms to ensure you get the most bang for your buck. We monitor performance closely to deliver unbeatable ROI.`,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
        ...
        subtitle: `Tap into the potential of Google Adwords. From keyword research to ad creation and bid optimization, We craft campaigns that convert. Reach your audience when it matters most.`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
